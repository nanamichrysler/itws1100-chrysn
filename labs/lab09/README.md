...
- an actors table => simply added actors to already working actors.php page

- a movies table => completed the program, similar to the actors page, to display the movies

- exported actors.csv & iit.sql

- began implementation of a relationship table between actors & movies (did not finish)
